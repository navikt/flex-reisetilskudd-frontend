const OppsummeringTekster: any = {
    'nb': {
        'oppsummering.dagens_transportmiddel.tittel': 'Hvordan reiste du før sykmeldingen?',
        'oppsummering.egenbil': 'Kjører egen bil, %KILOMETER% kilometer',
        'oppsummering.går': 'Går',
