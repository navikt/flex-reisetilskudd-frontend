...
import '../../../components/filopplaster/fil-liste.less'
...
import slettFilIkon from '../../../components/filopplaster/slett-fil-ikon.svg'
...
const Kvitteringer = ({ sporsmal }: SpmProps) => {
    const { valgtReisetilskudd, setValgtReisetilskudd, setOpenModal, setKvitteringIndex, setErBekreftet } = useAppStore()
